    ...
    <div className="min-h-screen bg-gradient-to-br from-[#E8F5E9] via-[#F3E5F5] to-[#E3F2FD] flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8 animate-fade-in">
          ...
          <p className="text-gray-500">Sign in to your learning platform</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="bg-white/70 backdrop-blur-xl rounded-3xl p-8 shadow-xl border border-white/50 space-y-5 animate-fade-in">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-3.5 bg-gray-900 text-white rounded-2xl font-medium hover:bg-gray-800 active:scale-[0.98] transition-all duration-300 flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {loading ? (
